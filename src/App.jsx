        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <img
              ...
              style={{
                ...
                height: 44,
                objectFit: "contain",
                filter: `drop-shadow(0 0 8px ${T.green}33)`,
                flexShrink: 0,
              }}
            />
            <div>
          ...
          <div style={{ display: "flex", gap: "20px" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: "9px", color: T.muted, textTransform: "uppercase", letterSpacing: "1px" }}>
                xp
              </div>
            </div>
            <div style={{ textAlign: "center" }}>
                ...
                <div key={u.id}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: NR * 2,
                      borderRadius: "50%",
                      background: sel ? u.color + "28" : done ? u.color + "16" : un ? "#0b1a10" : "#090c09",
        ...
        {mapSel && (
          ...
          >
            ...
            <div style={{ fontSize: "12px", color: T.muted, marginBottom: "18px" }}>
              ...
              {(prog[mapSel.id] || 0) > 0 ? "Practice to improve your score" : "5 quick questions"}
            </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            {[1, 2, 3].map((l) => (
              <span key={l} style={{ fontSize: "17px", opacity: l <= lives ? 1 : 0.14, transition: "opacity 0.35s" }}>
                ❤️
              </span>
            ))}
          </div>
        ...
        >
          <span style={{ fontFamily: "'VT323', monospace", fontSize: "18px", color: unit.color }}>+{lessonXp} XP</span>
      ...
      >
        ...
        {failed ? (
          <>
            ...
            <div style={{ color: T.muted, fontSize: "13px", marginTop: "8px" }}>Every expert was once a beginner</div>
          </>
        ) : (
          <>
            <div
